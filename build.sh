...
TOOLCHAIN=proton # List ( gcc = eva | aospa | reaPeR1010 ) (clang = proton | azure | neutron | atomx | aosp | sdclang )
...
elif [[ $TOOLCHAIN == "reaPeR1010" ]]; then
       post_msg " Cloning reaPeR1010 GCC ToolChain "
...
# Set PATH
if [[ "$TOOLCHAIN" == "eva" || "$TOOLCHAIN" == "aospa" || "$TOOLCHAIN" == "reaPeR1010" ]]; then
